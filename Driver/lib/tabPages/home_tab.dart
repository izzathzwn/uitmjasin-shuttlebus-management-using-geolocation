...
import 'package:drivers_app/models/pin_data.dart';
  ...
  static const CameraPosition _uitm = CameraPosition(
    ...
    readCurrentDriverInformation() {
      ...
      FirebaseDatabase.instance.ref().child("Drivers")
          .child(currentFirebaseUser!.uid).once().then((snap) {
        if (snap.snapshot.value != null) {
          ...
          onlineDriverData.bus_color =
          (snap.snapshot.value as Map)["Bus_details"]["plate_number"];
          ...
          GoogleMap(
            ...
            onMapCreated: (GoogleMapController controller) {
              ...
              listMarkers.add(Marker(
                  ...
                  position: const LatLng(2.216846, 102.452063),
                  infoWindow: const InfoWindow(title: "Bus Stand"),
                  icon: customIcon!));
            },
          ),
    ...
    driveIsOnlineNow() async
    {
      ...
      DatabaseReference ref = FirebaseDatabase.instance.ref().child("Drivers")
          .child(currentFirebaseUser!.uid).child("newRideStatus");
